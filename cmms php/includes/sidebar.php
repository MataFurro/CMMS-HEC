...
$menuItems = [
    ...
    ['name' => SIDEBAR_WORK_ORDERS, 'path' => 'work_orders', 'icon' => 'assignment'],
    ...
    ['name' => 'Solicitudes MS', 'path' => 'messenger_requests', 'icon' => 'mail'],
];
?>
    ...
    <div class="p-4 lg:p-8 flex flex-col items-center lg:items-start overflow-y-auto custom-scrollbar">
        <div class="flex items-center gap-3 mb-10 lg:mb-12">
            ...
            <div class="hidden lg:block">
                ...
                <p class="text-[10px] text-medical-blue font-black tracking-widest uppercase mt-1">v4.2 Pro Edition</p>
            </div>
        </div>
    ...
    <div class="mt-auto p-4 lg:p-8 border-t border-slate-700/50 w-full bg-medical-surface/50 backdrop-blur-md">
        <div class="flex items-center gap-4">
            <div class="size-10 rounded-full bg-slate-700 flex items-center justify-center shrink-0 overflow-hidden border border-slate-600 shadow-inner">
                <img src="<?= $_SESSION['user']['avatar'] ?>" class="w-full h-full object-cover" alt="User">
            </div>
            <div class="hidden lg:block overflow-hidden">
                <p class="text-xs font-bold text-white leading-none truncate"><?= $_SESSION['user']['name'] ?></p>
                <p class="text-[10px] text-medical-blue uppercase font-black tracking-widest mt-1.5 truncate"><?= $_SESSION['user']['role'] ?></p>
            </div>
        </div>
    </div>
</aside>