...
class WorkOrderRepository
{
    ...
    {
        $sql = "INSERT INTO work_orders (id, asset_id, type, status, assigned_tech_id, created_date, priority, observations, ms_request_id, ms_email, checklist_template, created_at) 
                VALUES (:id, :asset_id, :type, :status, :tech_id, :created_date, :priority, :observations, :ms_request_id, :ms_email, :checklist_template, NOW())";
