    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <nav class="flex items-center gap-2 mb-4">
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-medical-blue bg-medical-blue/10 px-2 py-0.5 rounded">Operaciones</span>
                <span class="material-symbols-outlined text-xs text-slate-600">chevron_right</span>
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Gestión de Mantenimiento</span>
            </nav>
            ...
            <p class="text-slate-400 mt-2 text-lg font-medium italic opacity-80">Seguimiento y ejecución de intervenciones técnicas en tiempo real.</p>
        </div>
        <?php if (canModify()): ?>
            <a href="?page=work_order_opening" class="group h-12 px-8 bg-medical-blue text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-medical-blue/90 flex items-center gap-3 transition-all shadow-xl shadow-medical-blue/20 active:scale-95">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="card-glass p-0 overflow-hidden group hover:border-medical-blue/30 transition-all duration-300">
            <div class="p-6 flex items-center gap-6">
                <div class="w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-500 shadow-inner group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl">pending_actions</span>
                </div>
                <div>
                    <p class="text-xs text-slate-500 font-black uppercase tracking-widest">Pendientes</p>
                    <p class="text-3xl font-black text-white mt-1">05 <span class="text-xs font-medium text-slate-600">unids</span></p>
                </div>
            </div>
        ...
        <div class="card-glass p-0 overflow-hidden group hover:border-amber-500/30 transition-all duration-300">
            <div class="p-6 flex items-center gap-6">
                <div class="w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-500 shadow-inner group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl">engineering</span>
                </div>
                <div>
                    <p class="text-xs text-slate-500 font-black uppercase tracking-widest">En Proceso</p>
                    <p class="text-3xl font-black text-white mt-1">02 <span class="text-xs font-medium text-slate-600">unids</span></p>
                </div>
            </div>
            <div class="h-1 w-full bg-slate-800">
        ...
        <div class="card-glass p-0 overflow-hidden group hover:border-emerald-500/30 transition-all duration-300">
            <div class="p-6 flex items-center gap-6">
                <div class="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 shadow-inner group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl">check_circle</span>
                </div>
                <div>
                    <p class="text-xs text-slate-500 font-black uppercase tracking-widest">Terminadas</p>
                    <p class="text-3xl font-black text-white mt-1">128 <span class="text-xs font-medium text-slate-600">unids</span></p>
                </div>
            </div>
            <div class="h-1 w-full bg-slate-800">
        ...
        <div class="card-glass p-0 overflow-hidden group hover:border-red-500/30 transition-all duration-300">
            <div class="p-6 flex items-center gap-6">
                <div class="w-14 h-14 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-500 shadow-inner group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl">emergency_home</span>
                </div>
                <div>
                    <p class="text-xs text-slate-500 font-black uppercase tracking-widest">Críticas Hoy</p>
                    <p class="text-3xl font-black text-white mt-1">01 <span class="text-xs font-medium text-slate-600">unids</span></p>
                </div>
            </div>
            <div class="h-1 w-full bg-slate-800">
                    ...
                    <tr class="ot-row hover:bg-white/5 transition-colors"
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="?page=work_order_execution&id=<?= $ot['id'] ?>" class="p-2 bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 rounded-lg transition-all border border-slate-700/50" title="Ver Detalles">
                                    <span class="material-symbols-outlined text-lg">visibility</span>
                                </a>
                                <?php if ($ot['status'] !== 'Terminada' && canExecuteWorkOrder()): ?>
                                    <a href="?page=work_order_execution&id=<?= $ot['id'] ?>&action=complete" class="px-4 py-2 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 rounded-lg text-[10px] font-black uppercase hover:bg-emerald-500 hover:text-white transition-all shadow-lg shadow-emerald-500/5">
                                        EJECUTAR
                                    </a>
                                <?php endif; ?>
                            </div>
