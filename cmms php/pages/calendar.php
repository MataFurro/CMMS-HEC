...
// Adaptar OTs al formato de eventos del calendario
$dayEvents = array_map(function ($ot) {
    return [
        'time' => date('H:i', strtotime($ot['date'] ?? '09:00')),
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-9">
                        ...
                        for ($i = -2; $i <= 32; $i++):
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-start mb-2">
                                    ...
                                    <?php if ($isToday): ?>
                                        <span
                                            class="size-2 rounded-full bg-medical-blue shadow-[0_0_12px_rgba(14,165,233,0.5)]"></span>
                                    <?php endif; ?>
                                </div>
                                <div class="space-y-1.5 overflow-hidden">
                                    <?php if ($i === 5): ?>
                                        <div
                                            class="px-2 py-1 bg-danger/10 border-l-2 border-danger rounded text-[9px] font-black text-danger truncate uppercase">
                                            OT #2026-0890</div>
                                    <?php elseif ($i === 8 || $i === 22): ?>
                                        <div
                                            class="px-2 py-1 bg-medical-blue/10 border-l-2 border-medical-blue rounded text-[9px] font-black text-medical-blue truncate uppercase">
                                            OT #2026-0885</div>
                                    <?php elseif ($i === 11): ?>
                                        <div
                                            class="px-2 py-1 bg-amber-500/10 border-l-2 border-amber-500 rounded text-[9px] font-black text-amber-500 truncate uppercase">
                                            OT #2026-0891</div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <?php elseif ($view === 'year'): ?>
                <div
                    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 animate-in fade-in zoom-in-95 duration-300">
                    <?php foreach ($annualWorkload as $idx => $item): ?>
                        <div
                            ...
                            <button
                                class="absolute inset-0 bg-medical-blue/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none group-hover:pointer-events-auto">
                                <span
                                    class="text-[10px] font-black text-medical-blue uppercase tracking-widest bg-medical-dark px-4 py-2 rounded-xl border border-medical-blue/30 shadow-2xl">Ver
                                    Detalle</span>
                            </button>
                        </div>
                    <?php endforeach; ?>
                    ...
                    <div class="h-[600px] overflow-y-auto custom-scrollbar">
                        <?php foreach ($hours as $hour): ?>
                            <div class="grid grid-cols-[80px_1fr_1fr_1fr_1fr_1fr_1fr_1fr] border-b border-border-dark/30">
                                ...
                                <?php foreach ($weekDays as $idx => $day): ?>
                                    <div
                                        class="border-r border-border-dark/30 relative min-h-[80px] hover:bg-white/[0.01] transition-colors">
            ...
            <?php elseif ($view === 'day'): ?>
                <div
                    ...
                    <div class="p-8 border-b border-border-dark bg-white/5 flex items-center justify-between">
                        ...
                        <div
                            class="flex items-center gap-4 bg-emerald-500/5 px-4 py-2 rounded-2xl border border-emerald-500/20">
                            <span class="size-2 rounded-full bg-emerald-500 animate-pulse"></span>
                            <span
                                class="text-[10px] font-black text-emerald-500 uppercase tracking-widest text-center">Técnicos
                                de Turno: 4/5 Disponibles</span>
                        </div>
                    </div>
                            ...
                            <div class="flex gap-8 group">
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between items-start">
                                        ...
                                        ?>
                                        <span
                                            class="text-[9px] font-black px-3 py-1 rounded-lg uppercase tracking-widest <?= $bgClass ?> border">
                                            <?= $statusLabel ?>
                                        </span>
                                    </div>
