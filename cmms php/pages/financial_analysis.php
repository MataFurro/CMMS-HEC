...
<div class="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <nav
                class="flex items-center gap-2 text-[10px] text-slate-500 uppercase tracking-[0.2em] font-black mb-3 text-shadow-sm">
            ...
            <h1 class="text-4xl font-black text-white tracking-tight flex items-center gap-4">
                ...
                <span
                    class="px-3 py-1 bg-medical-blue/10 text-medical-blue text-xs rounded-lg border border-medical-blue/20">FY
                    2026</span>
            </h1>
            <p class="text-slate-400 mt-2 text-lg font-medium">Gestión del Ciclo de Vida Económico y Costo Total de
                Propiedad (TCO).</p>
        </div>

        <div class="flex gap-3">
            <button
                class="px-6 py-3 bg-white/5 border border-slate-700/50 text-slate-300 rounded-2xl font-bold text-sm flex items-center gap-3 hover:bg-white/10 transition-all active:scale-95">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="card-glass p-6 group hover:border-medical-blue/30 transition-all">
            <div class="flex items-center gap-4 mb-4">
                ...
                <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none">Valor
                    Inventario</span>
            </div>
            <div class="flex flex-col">
                <span class="text-3xl font-black text-white">$<?= number_format($stats['valor_inventario']) ?></span>
        ...
        <div class="card-glass p-6 group hover:border-amber-500/30 transition-all">
            <div class="flex items-center gap-4 mb-4">
                ...
                <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none">Costo de
                    Mantenimiento</span>
            </div>
            <div class="flex flex-col">
                <span
                    class="text-3xl font-black text-white">$<?= number_format($stats['costo_mantenimiento_anual']) ?></span>
                <span class="text-xs font-bold text-amber-500 mt-1">Vea. vs Valor Activo: 8.0%</span>
            </div>
        </div>
        ...
        <div class="card-glass p-6 group hover:border-medical-blue/30 transition-all">
            <div class="flex items-center gap-4 mb-4">
                <div
                    class="p-3 bg-medical-blue/10 text-medical-blue rounded-xl group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined">equalizer</span>
                </div>
                <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none">TCO
                    Promedio</span>
            </div>
            <div class="flex flex-col">
        ...
        <div class="card-glass p-6 group hover:border-red-500/30 transition-all">
            <div class="flex items-center gap-4 mb-4">
                ...
                <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none">Equipos a
                    Reponer</span>
            </div>
            <div class="flex flex-col">
        ...
        <div class="lg:col-span-2 card-glass p-8 space-y-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-slate-400 text-sm mt-1">Cálculo de valor residual basado en uso, fallas e incidentes
                        adversos.</p>
                </div>
            </div>

            <div
                class="p-6 bg-slate-900/50 rounded-2xl border border-slate-700/50 font-mono text-xs text-medical-blue text-center shadow-inner">
                <?= $formula_tinc ?>
            </div>

            <div class="space-y-6">
                <div
                    class="flex items-center justify-between text-xs font-black uppercase tracking-[0.2em] text-slate-500 px-4">
    ...
    <div class="card-glass p-8">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 font-bold uppercase tracking-widest mt-0.5">Análisis Rent vs Buy y
                    Outsourcing</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
                class="p-6 bg-white/5 rounded-2xl border border-emerald-500/20 shadow-xl relative group overflow-hidden">
                <div
                ...
                <p class="text-xs text-slate-400 mt-2 leading-relaxed">Reducción de costos comparativa frente a
            ...
            <div class="p-6 bg-white/5 rounded-2xl border border-slate-700/50">
                ...
                <p class="text-xs text-slate-400 mt-2 leading-relaxed">Costo evitado por uso efectivo de pólizas de
